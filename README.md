...
-add variable : ANDROID_HOME C:\Users\""REPLACE_WITH_CURRENT_USER""\AppData\Local\Android\Sdk
-add variable : JAVA_HOME C:\Program Files\Java\jdk1.8.0_152 (latest version)
-edit path
-add :(Replace Imen BenAbderrahmen with current user)
